...
DROP TRIGGER IF EXISTS tabs_updated_at_trigger ON tabs;
...
DROP TRIGGER IF EXISTS tab_items_updated_at_trigger ON tab_items;
...
DROP TRIGGER IF EXISTS sync_table_status_trigger ON tabs;
...
DROP TRIGGER IF EXISTS prevent_multiple_open_tabs_trigger ON tabs;
...
DROP TRIGGER IF EXISTS calculate_tab_item_total_trigger ON tab_items;
...
DROP POLICY IF EXISTS "Admins and managers can create tables" ON tables;
...
DROP POLICY IF EXISTS "Admins and managers can update tables" ON tables;
...
DROP POLICY IF EXISTS "Admins and managers can delete tables" ON tables;
...
DROP POLICY IF EXISTS "Users can view tabs in their store" ON tabs;
...
DROP POLICY IF EXISTS "Store users can create tabs" ON tabs;
...
DROP POLICY IF EXISTS "Store users can update tabs" ON tabs;
...
DROP POLICY IF EXISTS "Admins and managers can delete tabs" ON tabs;
...
DROP POLICY IF EXISTS "Users can view tab items in their store" ON tab_items;
...
DROP POLICY IF EXISTS "Store users can create tab items" ON tab_items;
...
DROP POLICY IF EXISTS "Store users can update tab items" ON tab_items;
...
DROP POLICY IF EXISTS "Store users can delete tab items" ON tab_items;
