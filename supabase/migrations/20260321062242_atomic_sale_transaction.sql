/*
  ...
  1. Changes
    - Replaces `complete_sale_transaction` with fully atomic implementation
    - Moves ALL stock deduction logic into the database transaction
    - Supports product recipes (fichas técnicas)
    - Supports weight-based and unit-based products
    - Validates stock availability BEFORE creating sale
    - Creates sale, sale_items, cash_entry, and deducts stock atomically
    - Rolls back everything if any step fails

  2. Features
    - Pre-validates all stock requirements
    - Handles recipe-based stock deduction
    - Handles direct product-to-stock mapping
  ...
  3. Security
    ...
    - Validates cash session is open
...
-- Create comprehensive atomic sale function
